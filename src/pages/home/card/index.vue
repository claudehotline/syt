        ...
        <el-card class="box-card" shadow="hover">
            <div class="content">
                <div class="left">
                    ...
                    <div class="tip">
                        <div class="level"><svg t="1691224704193" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="1430" width="16" height="16">
                                <path
                                    ...
                                    fill="#000000" p-id="1431"></path>
                            </svg>
                            <span>{{hospitalInfo.param.hostypeString}}</span>
                        </div>
                        <div class="time"><svg t="1691224805036" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" p-id="2678" width="16" height="16">
                                <path
