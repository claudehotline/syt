<template>
    <div>
        <el-card class="box-card">
            ...
            <div class="top">
                <el-tag type="success">
                    <!--左侧的标签-->
                    <div class="tag">
                        <svg t="1691749399263" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="4144" width="16" height="16">
                            <path
        ...
        <!--展示支付二维码的结构-->
        <!--对话框通过v-model控制显示和影藏的true:显示 false隐藏-->
        <el-dialog v-model="dialogVisible" title="微信支付" width="400px" @close="close">
            <!--支付需要使用的二维码图片-->
            <div class="qrcode">
                <img :src="imgUrl" />
                <p>请使用微信扫一扫</p>
...
import { reqOrderInfo, reqCancelOrder, reqQrcode, reqQueryPayStatus } from '@/api/user';
